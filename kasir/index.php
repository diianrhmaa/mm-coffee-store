              ...
              <div class="card-body numbers">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8 text-right">
                    ...
                    ?>
                      <h5 class="mt-5"><?php echo $total_terjual; ?> Produk</h5>
                    <?php
                    }
                    ?>
                  </div>
            ...
            <div class="card" style="height: 18rem";>
              ...
              <div class="card-body numbers">
                <div class="row">
                  ...
                  ?>
                      <h5 class="mt-5"><?php echo $jumlah_pembeli;?> Orang</h5>
                  <?php
                    }
                  ?>
                  </div>
            ...
            <div class="card" style="height: 18rem";>
              ...
              <div class="card-body numbers">
                <div class="row">
                  ...
                  ?>
                      <h5 class="mt-5">Rp<?php echo $total_pendapatan; ?></h5>
                  <?php
                    }
                  ?>
                  </div>
