            ...
            <div class="col-lg-3 col-md-5 col-sm-5">
                  ...
                  <div class="modal-content">
                    ...
                    <form method="POST" action="transaction.php">
                      ...
                      <div class="modal-footer">
                        ...
                        <!-- <a class="btn btn-success" type="submit" name="createorder">Create</a> -->
                         
                        <!-- <a class="btn btn-success" href="order.php?edit=<?php echo $data['order_id']; ?>">Create</a> -->
              ...
              <?php
                if (isset($_POST['createorder'])) {
                    ...
                    $insert_customer = $dbh->query("INSERT INTO `order` (`date`, `harga_total`, `customer`, `metode_pembayaran`) 
                      ...
                      <tr>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center">
                              <a href='order.php?edit=<?php echo $data["order_id"]; ?>' class="btn btn-success">Tambah</a>
                              <!-- <a href='?order_id=<?php echo $data["order_id"]; ?>' class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data?')">Delete</a> -->
                        ...
                        <?php
                          if (isset($_GET['order_id'])) {
                            ...
                            $deleteOrder=$dbh->query("DELETE FROM `order_detail` WHERE `order_id` = '$deleteId'");
                            $delete = $dbh->query("DELETE FROM `order` WHERE `order_id` = '$deleteId'");
                            if ($delete) {
