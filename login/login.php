...
if (isset($_POST['submit'])) {
    ...
    // Menghindari serangan SQL injection dengan menggunakan prepared statements
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Menghindari serangan session hijacking dengan mengatur session dengan Secure dan HttpOnly flag
        session_set_cookie_params([
            'lifetime' => 86400, // Durasi cookie
            'path' => '/',
            'domain' => $_SERVER['HTTP_HOST'],
            'secure' => true, // Hanya dikirim melalui HTTPS
            'httponly' => true, // Tidak dapat diakses melalui JavaScript
            'samesite' => 'Strict' // Mencegah CSRF melalui metode POST
        ]);
        ...
        // Mengalihkan pengguna ke halaman yang sesuai berdasarkan tipe pengguna
        if ($usertype === 'kasir') {
            header("Location: ../kasir/index.php");
